...
from prompt_toolkit.filters.cli import ViNavigationMode, ViInsertMode, ViInsertMultipleMode, ViReplaceMode, \
	ViSelectionMode, ViWaitingForTextObjectMode, ViDigraphMode, ViMode
