...
def compiled_columns(scored_dir):
	...
	if mturk == 1:
		...
		for batch in range(1, 9):
			batch = str(batch)
			age_range_gender_csv = os.path.join(scored_dir, prefix + batch + '_age_range_gender.csv')
			...
			scored = os.path.join(scored_dir, prefix + batch + '_scored_data.csv')
			composite = os.path.join(scored_dir, prefix + batch + '_composite_scores.csv')
